...
class AdminController extends Controller
{
    ...
    {
        $criterias = Criteria::select('id', 'nama', 'tipe', 'bobot')->get();

        $totalCriterias = $criterias->sum('bobot');
        $countAlternatives = $criterias->count();
        $bobotC1 = $totalCriterias / $countAlternatives;

        // dd($bobotC1);
        return view('admin/data/criterias')->with([
            'criterias' => $criterias,
